...
if(
    ...
    <head>
        ...
        <title> Customer Login | Ecomarce</title>
    ...
    <body>
        ...
        <?php
            ...
            if(isset($_SESSION['justloggedin']) && $_SESSION['justloggedin'] == true){
                ...
                ?>
                    <div class="alert alert-primary alert-dismissible fade show" role="alert" id="wish-alert" style="margin-top: -3rem; margin-bottom: 2rem">
            ...
            <div class="d-flex justify-content-center d-flex align-items-center" style="flex-direction: column;">
                <h1 class="subtitle-text" style="margin-bottom: -0.5em;">
                    <strong style="font-size: 2em;"> Ecomarce </strong>
                </h1>
